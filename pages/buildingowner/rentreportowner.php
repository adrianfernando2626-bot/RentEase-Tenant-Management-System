...
<body>
    <div class="main">
        ...
        <div class="chart-container mb-4">
            ...
            <script src="script_rent_report.js"></script>
        </div>
                    ...
                    <div id="step1" class="tutorial-step">
                        ...
                        <div class="step-layout">
                            <div class="step-content">
                                <img src="../images/rent_report_help.png" alt="Add Building Screenshot" class="step-image">
                ...
                <div id="step2" class="tutorial-step">
                    ...
                    <div class="step-layout">
                        <div class="step-content">
                            ...
                            <img src="../images/arrow_generatereport_help.png" alt="Add Building Screenshot" class="step-image">
