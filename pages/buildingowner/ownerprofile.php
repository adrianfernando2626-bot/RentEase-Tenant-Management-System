        ...
        if ($img_size > 250000) {
            ...
            if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                if (mysqli_query($db_connection, $sql2)) {
                    echo "<script>
                            window.location.href = 'ownerprofile.php?message=account_image_updated';
                            </script>";
                    exit();
                    session_destroy();
                } else {
...
if (isset($_POST['updated_account'])) {
    ...
    if (strlen($phone_number) === 13 && substr($phone_number, 0, 4) === '+639' && $age >= 18) {
        ...
        if (mysqli_query($db_connection, $sql2)) {
            echo "<script>
            window.location.href = 'ownerprofile.php?message=account_updated';
        </script>";
        } else {
            echo mysqli_error($db_connection);
        }
...
<body>
    ...
    <main class="main">
        ...
        <form id="updateForm" method="POST" action="ownerprofile.php">
                    ...
                    <div id="step1" class="tutorial-step">
                        ...
                        <div class="step-layout">
                            <div class="step-content">
                                ...
                                <img src="../images/edit_profilr_help.png" alt="Add Building Screenshot" class="step-image">
