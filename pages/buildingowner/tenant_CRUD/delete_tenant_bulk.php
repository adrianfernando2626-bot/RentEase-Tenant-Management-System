...
$stmt = $pdo->prepare("SELECT user_id, first_name, last_name, email, room_id, img FROM userall WHERE user_id IN ($placeholders)");
...
$paymentStatusUpdateStmt = $pdo->prepare("UPDATE payment_status SET is_active = 0 WHERE payment_id = ?");
