...
if (isset($_GET['message']) && $_GET['message'] === 'password_success') {
    echo "<script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>";
    echo "<script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
        ...
        if ($img_size > 250000) {
            ...
            if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                if (mysqli_query($db_connection, $sql2)) {
                    echo "<script>
                            window.location.href = 'landlordprofile.php?message=account_image_updated';
                            </script>";
                    exit();
                    session_destroy();
                } else {
...
if (isset($_POST['updated_account'])) {
    ...
    if (strlen($phone_number) === 13 && substr($phone_number, 0, 4) === '+639' && $age >= 18) {
        ...
        if (mysqli_query($db_connection, $sql2)) {
            echo "<script>
            window.location.href = 'landlordprofile.php?message=account_updated';
        </script>";
        } else {
            echo mysqli_error($db_connection);
        }
...
<body>
    ...
    <main class="main">
        ...
        <div class="user-account-container">
            <form action="landlordprofile.php"
                method="post"
        ...
        <form id="updateForm" method="POST" action="landlordprofile.php">
                    ...
                    <div id="step1" class="tutorial-step">
                        ...
                        <div class="step-layout">
                            <div class="step-content">
                                ...
                                <img src="../images/landlord_profile_help.png" alt="Add Building Screenshot" class="step-image">
            ...
            <form method="POST" action="send_otp.php">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Change Password (OTP Required)</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <p>Click "Send OTP" to get a code via your registered email.</p>
                    </div>
